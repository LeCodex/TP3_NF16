 ...
 */
T_Soigneur* provided_ajouterSoigneur(T_Soigneur* listeSoigneurs, Index_Soigneur idSoi, char* nom, char* prenom);
/**
 * Fonction offerte.
 ...
 */
T_Patient* provided_ajouterPatient(T_Patient* listePatients, Index_Patient idPat, char* nom, char* prenom) ;
/**
 * Fonction offerte.
 ...
 */
T_RendezVous* provided_ajouterRendezVous(T_RendezVous* listeRdV, Index_Soigneur idSoi, Time dateDebutSouhaitee, Time dateFinSouhaitee, Time tempsDeplacement, char* desc) ;
/**
 * Fonction offerte.
 ...
 * @param desc une discription brève.
 */
void provided_modifierRendezVous(T_RendezVous* listeRdV, Index_Soigneur idSoi, Time dateDebutSouhaitee, Time dateFinSouhaitee, Time tempsDeplacement, char* desc) ;
/**
 * Fonction offerte.
